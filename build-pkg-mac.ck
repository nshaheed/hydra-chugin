...
ver.generateVersion("./", "Hydra_mac", "https://ccrma.stanford.edu/~nshaheed/" + path);
...
chout <= "scp Hydra_mac.zip nshaheed@ccrma-gate.stanford.edu:~/Library/Web/" <= path <= IO.newline();

// Generate a version definition json file, stores this in "chumpinate/<VerNo>/Chumpinate_mac.json"
ver.generateVersionDefinition("Hydra_mac", "./" );
